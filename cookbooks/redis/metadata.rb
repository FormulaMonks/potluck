...
attribute "redis/user",
  ...
  :description => "The user who will run redis. Default is redis.",
  :default => "redis"
  
attribute "redis/group",
  :display_name => "Redis group",
  :description => "The group redis will run under. Default is redis.",
  :default => "redis"
